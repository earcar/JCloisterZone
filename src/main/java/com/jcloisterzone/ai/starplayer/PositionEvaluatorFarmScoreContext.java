...
public class PositionEvaluatorFarmScoreContext extends FarmScoreContext implements AiScoreContext {
    
    private final Map<Feature, AiScoreContext> scoreCache;
    private boolean valid;
    
    public PositionEvaluatorFarmScoreContext(Game game, Map<Feature, AiScoreContext> scoreCache) {
        super(game); 
